...
- **Frontend E2E testing**: Added a Playwright smoke-test foundation for the frontend, including preview-backed Search and NotFound route checks, explicit mocked API/SSE bootstrap handling, runtime startup validation, and a dedicated `CI / E2E` workflow job. ([#83](https://github.com/mralexsaavedra/spotiarr/pull/83))
...
- **Playlists**: Reconcile Spotify preview totals by ensuring the track count in previews matches the actual tracks fetched. This fixes discrepancies where the "Total tracks" badge showed more items than the track list. ([#77](https://github.com/mralexsaavedra/spotiarr/pull/77))
...
## [1.3.0](https://github.com/mralexsaavedra/spotiarr/compare/v1.2.0...v1.3.0) (2026-04-17)
